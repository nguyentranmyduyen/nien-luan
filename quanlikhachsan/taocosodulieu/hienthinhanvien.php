...
<html>
    ...
    <body>
       ...
       <label align="center" style="font-weight: bold;">Ngày tháng năm sinh  </label>
        <input name="NGAY_SINH" id="tensv" type="text" placeholder="" /> <br><br>
               ...
               if (mysqli_num_rows($result)>0){
                    while ($row= mysqli_fetch_array($result)){
                        ...
                        echo "<tr>
                            ...
                            <td>$DIA_CHI</td>
                            <td>$SO_DT</td>
                            <td><a href='suanhanvien.php?MA_NV2=".$row['MA_NV2']."'>Sửa</a></td>
                            <td><a href='xoanhanvien.php?MA_NV2=".$row['MA_NV2']."'>Xóa</a></td>
                        </tr>";
                    }
                }
                ?>
